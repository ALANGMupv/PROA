                ...
                <form id="formulario-examen">
                    ...
                    <div class="datos">
                        ...
                        <div class="titulo-texto">
                            ...
                            <input type="text" class="input-base" id="titulo-examen" placeholder="Ej: Cuestionario 1 del tema 1" value="Cuestionario" required>
                        </div>
                        ...
                        <div class="parametros">
                            ...
                            <div class="contenedor-valor-peso">
                                <label>
                                    <span>Peso: *</span>
                                    <div class="peso">
                                        <input type="number" class="input-base" id="peso-examen" max="40" value="10" required>
                                        <span>%</span>
                                    </div>
                                </label>
                                <label>
                        ...
                        <div class="pregunta-contenedor" data-id="pregunta1">
                            ...
                            <div class="titulo-texto-pregunta">
                                ...
                                <textarea name="pregunta1" id="pregunta1" cols="30" rows="3" class="input-base input-pregunta"
                                          placeholder="Escribe la pregunta aquí..." required>Cuantas horas se deben de dormir para estar sano?</textarea>
                            </div>
                            ...
                            <div class="respuestas-contenedor">
                                ...
                                <div class="respuesta-opcion">
                                    ...
                                    <input type="text" class="input-base input-respuesta" placeholder="Escribe la respuesta aquí..." value="8" required>
                                    <img src="../icons/trash.svg" alt="Eliminar" class="icono-eliminar" onclick="eliminarElemento(this)">
                                </div>
                                ...
                                <div class="respuesta-opcion">
                                    ...
                                    <input type="text" class="input-base input-respuesta" placeholder="Escribe la respuesta aquí..." value="10" required>
                                    <img src="../icons/trash.svg" alt="Eliminar" class="icono-eliminar" onclick="eliminarElemento(this)">
                                </div>

                                <div class="respuesta-opcion">
                                    <div class="radio-grupo">
                                        <input type="radio" id="pregunta1-c" name="pregunta1" required>
                                        <label for="pregunta1-b">C.</label>
                                    </div>
                                    <input type="text" class="input-base input-respuesta" placeholder="Escribe la respuesta aquí..." value="2" required>
                                    <img src="../icons/trash.svg" alt="Eliminar" class="icono-eliminar" onclick="eliminarElemento(this)">
                                </div>

                                <div class="respuesta-opcion">
                                    <div class="radio-grupo">
                                        <input type="radio" id="pregunta1-d" name="pregunta1" required>
                                        <label for="pregunta1-b">D.</label>
                                    </div>
                                    <input type="text" class="input-base input-respuesta" placeholder="Escribe la respuesta aquí..." value="5" required>
                                    <img src="../icons/trash.svg" alt="Eliminar" class="icono-eliminar" onclick="eliminarElemento(this)">
                                </div>
                            </div>
                        ...
                        <div class="pregunta-contenedor" data-id="pregunta2">
                            ...
                            <div class="titulo-texto-pregunta">
                                ...
                                <textarea name="pregunta1" id="pregunta2" cols="30" rows="3" class="input-base input-pregunta"
                                          placeholder="Escribe la pregunta aquí..." required>Programar conlleva falta de sueño?</textarea>
                            </div>
                            ...
                            <div class="respuestas-contenedor">
                                ...
                                <div class="respuesta-opcion">
                                    <div class="radio-grupo">
                                        <input type="radio" id="pregunta2-a" name="pregunta2" required>
                                        <label for="pregunta2-a">A.</label>
                                    </div>
                                    <input type="text" class="input-base input-respuesta" placeholder="Escribe la respuesta aquí..." value="no" required>
                                    <img src="../icons/trash.svg" alt="Eliminar" class="icono-eliminar" onclick="eliminarElemento(this)">
                                </div>

                                <div class="respuesta-opcion">
                                    <div class="radio-grupo">
                                        <input type="radio" id="pregunta2-b" name="pregunta2" checked>
                                        <label for="pregunta2-b">B.</label>
                                    </div>
                                    <input type="text" class="input-base input-respuesta" placeholder="Escribe la respuesta aquí..." value="Si" required>
                                    <img src="../icons/trash.svg" alt="Eliminar" class="icono-eliminar" onclick="eliminarElemento(this)">
                                </div>
                            </div>
