...
<head>
    ...
    <link rel="stylesheet" href="css/ficha-examen-profesor.css">
    ...
    <script src="js/ficha-examen-profesor.js"></script>
</head>
<body>
            ...
            <section class="panel-contenido fondoPanel">
                <div class="descripcion">
                    ...
                    <div class="titulo-con-boton">
                        <h1 id="titulo-examen" class="titulo">Cuestionario 1</h1>
                        <div class="botones-edicion">
                            <button id="btn-modificar" class="btn-oscuros-secundario">Modificar</button>
                            <button id="btn-guardar" class="btn-oscuros" style="display: none;">Guardar</button>
                        </div>
                    </div>
